...
with_node \
  ...
  --target "/Users/user273643/Downloads/App-tce/ios/Pods/Target Support Files/Pods-TCApp/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo-application" "expo-av" "expo-constants" "expo-crypto" "expo-file-system" "expo-keep-awake" "expo-router" "expo-web-browser"
